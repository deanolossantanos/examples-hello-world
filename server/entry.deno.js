...
import { v as verifySerializable$1, _ as _serializeData, a as _deserializeData } from './q-DNXU7C1w.js';
import { s as setServerPlatform2, r as render } from './q-C25jcv1m.js';
...
function createRequestEvent(serverRequestEv, loadedRoute, requestHandlers, trailingSlash, basePathname, qwikSerializer, resolved) {
  ...
  const requestEv = {
    ...
    rewrite: (pathname2) => {
      ...
      return new RewriteMessage(pathname2.replace(/\/+/g, "/"));
    },
    defer: (returnData) => {
